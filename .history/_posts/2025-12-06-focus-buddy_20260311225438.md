...
description: "Exploring Windows process handling with win32 APIs to capture active windows and building a SQLite database skeleton for time-tracking data."
tags: [python, windows-api, sqlite, time-tracking]
---
