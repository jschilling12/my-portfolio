---
layout: default
title: "About Jordan Schilling | Technologist and Software Engineer"
description: "Learn about Jordan Schilling — a technologist and software engineer focused on automation systems, civic technology, and experimental tools."
permalink: /about-jordan-schilling
---
...
I'm interested in civic technology — software built to serve the public interest. Projects like JustABill represent my belief that technology should empower citizens and improve democratic processes. This interest drives some of my most ambitious and meaningful work.

### AI & Experimental Software

I'm actively exploring the intersection of AI and software engineering. From LLM-assisted development workflows to prompt engineering experiments, I approach AI as a practical tool to be understood and integrated — not a magic solution, but a powerful capability to be wielded with engineering discipline.
...
* **JustABill** — A civic technology project aimed at making legislative information accessible.
...
* **Docker & Containerization** — Actively learning container orchestration, Dockerfile authoring, and container-based CI/CD pipelines.
* **Infrastructure as Code** — Ansible playbooks and Terraform configurations are on my immediate learning path.
* **Observability & Monitoring** — Prometheus, Grafana, and structured logging are the next frontier for my DevOps skill set.
* **Backend API Development** — Planning to build RESTful and event-driven backend services to complement the automation and tooling work.
* **Open Source Contributions** — Committed to contributing to open-source projects in the automation and DevOps ecosystem.
